...
![](https://img.shields.io/badge/Shiny-Not yet hosted-blue?style=flat&labelColor=white&logo=RStudio&logoColor=blue)
<!-- badges: end -->

This is a work-in-progress Shiny app to test how good you are at deciphering a colour from its hex code.

The app is built around [the {dehex} package](https://github.com/matt-dray/dehex), which follows [David DeSandro's method](https://metafizzy.co/blog/read-color-hex-codes/) for learning how to assess hex codes by eye. 
...
You can [read about {dehex} in an accompanying blog post](https://www.rostrum.blog/2021/08/10/dehex/).
