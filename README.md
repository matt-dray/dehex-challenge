...
The app is in in development and not yet hosted on the web. If you want to see it, you could run this from an R session (but be aware that it's in early development):
